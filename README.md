...
>
> `Svelte`, `Zustand`, `Redux Toolkit`, `Redux Toolkit Query`, `TanStack Query`, `TanStack Table`, `React Context API`, `React DOM`, `React Router`, `OpenAI API`, `Replicate API`, `Regression-js`, `Recharts`, `Axios`, `Stripe`, `Clerk`, `Auth.js`, `SCSS`, `PostCSS`, `CSS Modules`, `Styled Components`, `StyleX`, `Shadcn-ui`, `WebGL`, `Webhooks`, `JWT`, `OAuth`,
...
>
> `Bun`,`Prisma`, `Drizzle`, `Zod`, `Yup`,`Redis`, `REST APIs`, `Socket.io`, `Server Actions`, `WebSockets`, `Payload CMS`, `WebRTC`, `Ngrok`, `Svix`, `Upstash Redis`, `SQLite`, `Mongoose`, `Nodemailer`
